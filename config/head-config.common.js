...
module.exports = {
  link: [
    /* add to the <head> of the index.html preload.css
    * Preload animation (takes place before our app has been bootstraped)
    * */
    { rel: "stylesheet", href: "/preload.css" },

    /* Angular Material style sheet */
    { rel: "stylesheet", href: "http://ajax.googleapis.com/ajax/libs/angular_material/1.1.0/angular-material.min.css" },

    //Toaster
    // { rel: "stylesheet", href: "node_modules/ng2-toastr/bundles/ng2-toastr.min.css" },
